...
function addElements(originalArray, ...newElements) {

    //newElements.forEach(n => originalArray.push(n))

    originalArray = [...originalArray, ...newElements]

    console.table(originalArray)
}

addElements(elements, 5,6,7)
